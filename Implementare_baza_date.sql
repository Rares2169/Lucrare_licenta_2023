...
CREATE SEQUENCE masuratori_id_seq
START WITH
10000 INCREMENT BY 1;

CREATE OR REPLACE
TRIGGER masuratori_insert_trigger
BEFORE
INSERT
	ON
...
CREATE OR REPLACE
TRIGGER cicluri_insert_trigger
BEFORE
INSERT
	ON
	PROJECT_OWNER.CICLURI_INC_DESC
FOR EACH ROW
BEGIN
		SELECT
	ciclu_id_seq.NEXTVAL
...
CREATE SEQUENCE incarcari_id_seq
START WITH
1234 INCREMENT BY 1;
...
CREATE OR REPLACE
TRIGGER incarcari_insert_trigger
BEFORE
INSERT
	ON
	PROJECT_OWNER.INCARCARI
FOR EACH ROW
BEGIN
		SELECT
	incarcari_id_seq.NEXTVAL
...
CREATE SEQUENCE descarcari_id_seq
START WITH
4321 INCREMENT BY 1;
...
CREATE OR REPLACE
TRIGGER descarcari_insert_trigger
BEFORE
INSERT
	ON
	PROJECT_OWNER.DESCARCARI
FOR EACH ROW
BEGIN
		SELECT
	descarcari_id_seq.NEXTVAL
